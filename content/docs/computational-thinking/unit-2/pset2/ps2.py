...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        for p in self.positions:
            if p.getX() == math.floor(pos.getX()) \
                and p.getY() == math.floor(pos.getY()):
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return self.getNumTiles() - len(self.positions)
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        return pos.getX() < self.width and pos.getX() >= 0 \
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for time in range(num_trials):
        ...
        # anim.done()
    return round((steps_amount / num_trials), 1)
...
#     plot.
#
# showPlot1("Times It Takes 1 - 10 Robots To Clean 80% Of A Room", "Number Of Robots", "Times-steps")
#
# 2) Write a function call to showPlot2 that generates an appropriately-labeled
#     plot.
#
showPlot2("Times It Takes To Clean 80% Of Variously Shaped Rooms", \
          "Aspect Ratio", "Times-steps")

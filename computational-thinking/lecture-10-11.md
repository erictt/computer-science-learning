...
* Finding `k`
  ...
  * First we should know:
    ...
    * `k=-F/x`
    * `k=9.81*m/x`
    * ![](../.gitbook/assets/15026205788878.jpg)
    ...
    * Plot the data, we got:
      * ![](../.gitbook/assets/15026267364688%20%281%29.jpg)
    ...
    * Next step is to fit curves to data.
      ...
      * Then, finding the best fit is an optimization problem. most commonly used **objective function** is called **least squares**:
        * \\(\displaystyle\sum\_{i=0}^{len\(observed\)-1}\(observed\[i\] - predicted\[i\]\)^2\\)
  ...
  * Visualizing the Fit
    ...
    * ![](../.gitbook/assets/15026310672144%20%281%29.jpg)
    * `k = 21.53686`

### Another Experiment

* to fit curves to these mystery data:
  * ![](../.gitbook/assets/15026317050419%20%281%29.jpg)
  * ![](../.gitbook/assets/15026317968585.jpg)
...
* \\(R^{2}=1-\frac{\sum_{i}\(y\_i-p\_i\)^2}{\sum_{i}\(y\_i-\mu\_i\)^2}\\)
...
* Testing Goodness of Fits
  ...
  ![](../.gitbook/assets/15026333280446.jpg)
  ...
  * Since the degree of polynomial can affect the Goodness of Fits, what if we use some bigger ones? Can we get a tighter Fit?
    * ![](../.gitbook/assets/15026337479826.jpg)
...
* Let’s Look at Two Data Sets
  ...
  ![](../.gitbook/assets/15027059715810.jpg) ![](../.gitbook/assets/15027059831308%20%281%29.jpg)
...
* **Cross Validate**
  ...
  * A better indication of generalizability than training error
    ...
    ![](../.gitbook/assets/15027063556417%20%281%29.jpg) ![](../.gitbook/assets/15027063684730.jpg)
  ...
  * if data is noisy, can fit the noise rather than the underlying pattern in the data?
    * for example:
      ...
      * Fit `y=ax^2+bx+c`, we got:
        * ![](../.gitbook/assets/15027074566435.jpg)
        * R-squared = 0.7026
      * suppose we had used a first-degree fit
        * `model = pylab.polyfit(xVals, yVals, 1)`
        * ![](../.gitbook/assets/15027075365363%20%281%29.jpg)
* Conclusion
...
* The Whole Data Set:
  * ![](../.gitbook/assets/15027089786238%20%281%29.jpg)
* Results:

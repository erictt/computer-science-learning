...
* Let’s Look at Two Data Sets
   ...
   <img src="media/15027059715810.jpg" width=250 /> <img src="media/15027059831308.jpg" width=250 />
...
* **Cross Validate**
   ...
   * A better indication of generalizability than training error
   ...
   <img src="media/15027063556417.jpg" width=250 /> <img src="media/15027063684730.jpg" width=250 />
   ...
   * if data is noisy, can fit the noise rather than the underlying pattern in the data?
       * for example:
           ...
           * Fit `y=ax^2+bx+c`, we got:
               * <img src="media/15027074566435.jpg" width=250 />
               * R-squared = 0.7026
           * suppose we had used a first-degree fit
               * `model = pylab.polyfit(xVals, yVals, 1)`
               * <img src="media/15027075365363.jpg" width=250 />
...
* Task: Model how the mean daily high temperature in the U.S. varied from 1961 through 2015
    ...
    * Code: [lecture11-3.py](./unit-4/lecture11-3.py)
    
* The Whole Data Set:
    * <img src="media/15027089786238.jpg" width=250 />
* Results:

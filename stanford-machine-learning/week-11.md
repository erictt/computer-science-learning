...
* Photo OCR Pipeline(a machine learning pipeline):
    * <img src="media/15134246854400.jpg" style="width:500px" />
    * <img src="media/15134257884572.jpg" style="width:500px" />
...
* In order to talk about detecting things in images let's start with a simpler example of **pedestrian detection**.
    * <img src="media/15134298585353.jpg" style="width:300px" />
...
* Now we have a new image - how do we find pedestrians in it?
    ...
    * <img src="media/15134982376433.jpg" style="width:400px" />
    ...
    * Hopefully, we will eventually get this:
        * <img src="media/15134985480977.jpg" style="width:400px" />

* **Back to Text Detection**

    * <img src="media/15134988946460.jpg" style="width:400px" />
    ...
    * Having trained the classifier we apply it to an image
        ...
        * If you do that end up with something like this
            * <img src="media/15134988507588.jpg" style="width:300px" />
            * Black - no text
            * White - text
        ...
        * Take classifier output and apply an **expansion algorithm**
            ...
            * <img src="media/15135005982016.jpg" style="width:300px" />
...
* <img src="media/15135007906121.jpg" style="width:500px" />
...
2. Distort the exist data set
    * <img src="media/15135012525417.jpg" style="width:400px" />  
...
* Take the Photo OCR pipeline as the example:
    ...
    * Steps:
        ...
        3. Finally doe the same for character recognition
            * Goes up to 100%
    * <img src="media/15135020893319.jpg" style="width:400px" />

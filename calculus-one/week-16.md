...
* For example, \\(f(x) = x^2, g(x) = 1, a = -1, b = 1\\)
    * <img src="media/15133913603757.jpg" width=400 />
...
* For example, \\(f(x)=\sqrt{x}, g(x) = \sqrt{2x-1}, a = 0, b = 1\\)
    * <img src="media/15133918711067.jpg" width=150 />
    ...
    * <img src="media/15133921653408.jpg" width=400 />

## Volumes

### Sphere's Volume 

* <img src="media/15133953453310.jpg" width=200 />
...
* <img src="media/15133945593771.jpg" width=500 />
...
* For example: Find the volume of the solid obtained by rotating the region bounded by \\(y=x-x^2\\) and \\(y=0\\) about the line \\(x = 2\\).
    ...
    * <img src="media/15133966245462.jpg" width=500 />
...
* **Proves**:
    ...
    * <img src="media/15134033023491.jpg" width=250 />
